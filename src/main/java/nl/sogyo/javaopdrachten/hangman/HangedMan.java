...
public class HangedMan {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Scanner wordList = new Scanner(new File("./MyClassmates.txt"));
        ...
        System.out.println("----------------------------------");
        System.out.println("|Hangman game  --  Guess the name|");
        System.out.println("----------------------------------");
        ...
        while (continueGame) {
            ...
            for (int i = 0; i < word.length(); i++) { // looping the show of letters and printing them if guessed
                                                      // correctly.
            ...
            boolean wordGuessed = word.chars().mapToObj(i -> previousGuesses.contains((char) i)).allMatch(b -> b);
